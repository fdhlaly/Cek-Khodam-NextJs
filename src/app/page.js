...
export default function Home() {
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full max-w-sm p-6 bg-white bg-opacity-50 border-2 border-white rounded-lg">
      <div className="flex flex-col items-center justify-center w-full gap-4 mb-8">
        <input
          ...
          className="w-full h-12 text-xl text-center border-2 border-transparent rounded-full focus:outline-none focus:bg-gray-800 focus:text-white focus:border-gray-300"
        />
        <button
          id="cek"
          onClick={submitValue}
